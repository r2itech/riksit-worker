...
function buildPrompt(articles: RawArticle[]): string {
	...
	return [
		...
		'tentukan:',
		'',
		'1. Apakah artikel ini berkaitan dengan isu lingkungan? (isEnvironmental: true/false)',
		'',
		'   HANYA tandai isEnvironmental: true jika artikel memenuhi MINIMAL SATU',
		'   kriteria berikut:',
		'   - Pencemaran udara, air, atau tanah di Indonesia',
		'   - Sampah, limbah, atau pengelolaan sampah di Indonesia',
		'   - Kebakaran hutan atau lahan di Indonesia',
		'   - Banjir atau bencana alam yang berkaitan dengan kerusakan lingkungan di Indonesia',
		'   - Polusi industri atau pertambangan di Indonesia',
		'   - Kerusakan ekosistem, deforestasi, atau perusakan alam di Indonesia',
		'   - Program atau kebijakan pemerintah Indonesia terkait lingkungan hidup',
		'   - Clean city, kota bersih, atau sanitasi lingkungan di Indonesia',
		'',
		'   JANGAN tandai isEnvironmental: true jika:',
		'   - Berita politik, ekonomi, atau sosial yang tidak berkaitan langsung dengan lingkungan',
		'   - Berita olahraga, hiburan, atau gaya hidup',
		'   - Berita kriminal kecuali berkaitan dengan kejahatan lingkungan',
		'   - Berita dari luar Indonesia',
		'   - Berita teknologi atau bisnis kecuali berkaitan dengan teknologi lingkungan',
		'',
		'   Jika ragu, pilih isEnvironmental: false.',
		'',
